import mongoose, { Model, DefaultSchemaOptions, ObtainDocumentType, ResolveSchemaOptions, Schema, SchemaDefinition, SchemaDefinitionType } from "mongoose";
...
export declare function modelFactory<ModelType extends Base>(modelName: string, schema: Schema<ModelType, Model<ModelType>, ModelType>): (initializedService: MongooseContextFactory) => Model<ModelType>;
