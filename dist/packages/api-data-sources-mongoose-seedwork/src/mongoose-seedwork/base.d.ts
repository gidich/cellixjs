...
export declare const BaseOptions: SchemaOptions;
/**
...
export declare const SubdocumentBaseOptions: SchemaOptions;
/**
...
export declare const NestedPathOptions: SchemaOptions;
