...
const vendor_user_1 = require("./vendor-user");
...
describe('domain.contexts.end-user', () => {
    describe('when creating a new end user', () => {
        ...
        const mockVendorUserVisa = jest.mocked({});
        givenValidContext.domainVisa = jest.mocked({
            forCommunity: jest.fn(() => mockCommunityVisa),
            forUser: jest.fn(() => mockVendorUserVisa),
            ...
            forVendorUser: jest.fn(() => mockVendorUserVisa),
        ...
        it('should reject an invalid externalId', () => {
            ...
            const creatingInvalidUser = () => {
                vendor_user_1.VendorUser.getNewUser(userProps, givenInvalidExternalId, givenValidLastName, givenValidContext, givenValidFirstName);
            };
            // Assert
        ...
        it('should reject an invalid restOfName', () => {
            ...
            // Act
            const creatingInvalidUser = () => {
                vendor_user_1.VendorUser.getNewUser(userProps, givenValidExternalId, givenValidLastName, givenValidContext, givenInvalidRestOfName);
            };
            // Assert
        ...
        it('should reject an invalid lastName', () => {
            ...
            // Act
            const creatingInvalidUser = () => {
                vendor_user_1.VendorUser.getNewUser(userProps, givenValidExternalId, givenInvalidLastName, givenValidContext, givenValidFirstName);
            };
            // Assert
            expect(creatingInvalidUser).toThrowError('Too long');
        });
        it('should raise an VendorUserCreatedEvent', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            ...
            // Act
            const user = vendor_user_1.VendorUser.getNewUser(userProps, givenValidExternalId, givenValidLastName, givenValidContext, givenValidFirstName);
            // Assert
            const integrationEvent = user.getIntegrationEvents().find(e => e.aggregateId === expectedNewId && e instanceof vendor_user_created_1.VendorUserCreatedEvent);
        ...
        it('should set legalNameConsistsOfOneName to true when restOfName is not provided', () => {
            ...
            const userProps = jest.mocked({ personalInformation: { contactInformation: {}, identityDetails: {} } });
            // Act
            const user = vendor_user_1.VendorUser.getNewUser(userProps, givenValidExternalId, givenValidLastName, givenValidContext);
            // Assert
    ...
    describe('when updating an end user', () => {
        it('should reject an invalid email', () => {
            ...
            const user = new vendor_user_1.VendorUser(userProps, givenValidContext);
...
//# sourceMappingURL=vendor-user.test.js.map