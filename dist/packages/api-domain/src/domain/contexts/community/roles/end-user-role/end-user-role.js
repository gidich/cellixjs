...
exports.EndUserRole = void 0;
//import { DomainEntityProps } from '../../../../../../../seedwork/domain-seedwork/domain-entity';
const end_user_role_permissions_1 = require("./end-user-role-permissions");
const ValueObjects = __importStar(require("./end-user-role.value-objects"));
...
class EndUserRole extends cellix_domain_seedwork_1.DomainSeedwork.AggregateRoot {
    ...
    get permissions() {
        return new end_user_role_permissions_1.EndUserRolePermissions(this.props.permissions, this.visa);
    }
    get roleType() {
...
exports.EndUserRole = EndUserRole;
//# sourceMappingURL=end-user-role.js.map