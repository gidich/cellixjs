...
describe('domain.contexts.member', () => {
    describe('when creating a new member', () => {
        ...
        it('should reject an invalid name', () => {
            ...
            const creatingInvalidMember = () => {
                member_1.Member.getNewInstance(memberProps, givenInvalidName, givenValidCommunity, givenValidContext);
            };
            // Assert
        ...
        it('should accept valid input', () => {
            ...
            const creatingValidMember = () => {
                member_1.Member.getNewInstance(memberProps, givenValidName, givenValidCommunity, givenValidContext);
            };
            // Assert
    ...
    describe('when updating a member', () => {
        ...
        it('should reject an invalid email', () => {
            // Arrange
            const member = new member_1.Member(memberProps, givenValidContext);
