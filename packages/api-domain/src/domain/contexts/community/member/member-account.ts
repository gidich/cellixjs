  ...
  private validateVisa() {
    if (
      !this.visa.determineIf(
        (domainPermissions) => domainPermissions.isSystemAccount || domainPermissions.canManageMembers || (domainPermissions.canEditOwnMemberAccounts && domainPermissions.isEditingOwnMemberAccount)
      )
    ) {
