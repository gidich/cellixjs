  ...
  describe('when creating a new community', () => {
    ...
    it('should reject an invalid Name', () => {
      ...
      const creatingInvalidCommunity = () => {
        Community.getNewInstance(givenValidNewProps, givenInvalidCommunityName, givenValidCreatedBy, givenValidPassport);
      };
    ...
    it('should raise a CommunityCreatedEvent', () => {
      ...
      // Act
      const community = Community.getNewInstance(givenValidNewProps, givenValidCommunityName, givenValidCreatedBy, givenValidPassport);
