Feature: <Entity> EndUserIdentityDetails
  ...
  Scenario: Creating a new EndUserIdentityDetails instance
  ...
  Scenario: Changing the lastName with permission to manage end users
  ...
  Scenario: Changing the legalNameConsistsOfOneName with permission to manage end users
    Given an EndUserIdentityDetails entity with permission to manage end users
    When I set the legalNameConsistsOfOneName to true
    Then the entity's legalNameConsistsOfOneName should be true
  ...
  Scenario: Changing the restOfName with permission to manage end users
    Given an EndUserIdentityDetails entity with permission to manage end users
    When I set the restOfName to "Bob"
    Then the entity's restOfName should be "Bob"
