Feature: <ValueObject> VendorUser Value Objects
  ...
  Scenario: Creating a rest of name with minimum allowed length
    When I create a rest of name with a string of 1 character
    Then the value should be the 1 character string

  Scenario: Creating a rest of name with less than minimum allowed length
  ...
  Scenario: Creating a last name with minimum allowed length
