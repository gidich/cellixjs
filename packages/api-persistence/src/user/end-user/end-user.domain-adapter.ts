...
export class EndUserConverter extends MongooseSeedwork.MongoTypeConverter<Models.User.EndUser, EndUserDomainAdapter, Domain.Passport, Domain.Contexts.User.EndUser.EndUser<EndUserDomainAdapter>> {
  constructor() {
