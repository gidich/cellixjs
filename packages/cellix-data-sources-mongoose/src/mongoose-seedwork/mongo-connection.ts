import mongoose, {Model, type DefaultSchemaOptions, type ObtainDocumentType, type ResolveSchemaOptions, Schema, type SchemaDefinition, type SchemaDefinitionType} from 'mongoose';
