...
const defaultAttributes = { type: Boolean, required: true, default: false };
export const EndUserRoleSchema = new Schema<EndUserRole, Model<EndUserRole>, EndUserRole>(
  {
    ...
    permissions: {
      ...
      serviceTicketPermissions: {
        canCreateTickets: { ...defaultAttributes },
        canManageTickets: { ...defaultAttributes },
        canAssignTickets: { ...defaultAttributes },
        canWorkOnTickets: {
          ...defaultAttributes,
          index: true
        }
      ...
      violationTicketPermissions: {
        ...
        canManageTickets: { ...defaultAttributes },
        canAssignTickets: { ...defaultAttributes },
        canWorkOnTickets: { ...defaultAttributes }
      },
      communityPermissions: {
        ...
        canManageSiteContent: { ...defaultAttributes },
        canManageMembers: { ...defaultAttributes },
        canEditOwnMemberProfile: { ...defaultAttributes },
        canEditOwnMemberAccounts: { ...defaultAttributes }
      },
      propertyPermissions: {
        canManageProperties: { ...defaultAttributes },
        canEditOwnProperty: { ...defaultAttributes }
      }
    },
